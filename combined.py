...
import person_recognition
import numpy as np
>>>>>>> parent of fbdc2c7 (big push incoming):combined.py
========
import person_recognition
>>>>>>>> parent of f5ceebb (organization stuff):combined.py
from sklearn.metrics.pairwise import cosine_similarity
...
>>>>>>> parent of f5ceebb (organization stuff)
